// directly copied from "github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter/expr" because it is an internal package and I'm not sure how to deploy this as an actual part of the otel-collector-contrib package
// okay, not "directly" copied, the package was changed from expr to utils lol
package utils // import "github.com/luke-moehlenbrock/otel-collector-trace-hierarchy-processor/tracehierarchyprocessor/internal/utils"
